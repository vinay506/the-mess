...
angular.module('app').run(['$templateCache', function($templateCache) {$templateCache.put('app/header/header.html','<!-- <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script> -->\r\n<div class="jumbotron text-center" ng-if="!getUserName()">\r\n    <div class="header">\r\n        <h2>About the page</h2>\r\n        <span>\r\n    Page is Under Construction\r\n    </span>\r\n    </div>\r\n</div>\r\n<nav class="navbar navbar-inverse" ng-if="getUserName()">\r\n    <div class="container-fluid">\r\n        <div class="navbar-header">\r\n            <img class="navbar-brand brand-css" src="/app/components/header/images/favicon.ico.png" alt="{{menu.brand.name}}" title="{{menu.brand.name}}">\r\n        </div>\r\n        <ul class="nav navbar-nav" ng-repeat="page in menu.Pages">\r\n            <li ng-class="{active:page.isActive == true}" ng-click="activatePage(page)"><a class="active" href="javascript:void(0)">{{page.name}}</a></li>\r\n        </ul>\r\n        <ul class="nav navbar-nav navbar-right ">\r\n            <li><a><span class="glyphicon glyphicon-user "></span>{{" " +getUserName()}}</a></li>\r\n            <li><a href="javascript:void(0) " ng-click="logOut() "><span class="glyphicon glyphicon-log-out"></span> Sign Out</a></li>\r\n        </ul>\r\n    </div>\r\n</nav>');
$templateCache.put('app/home/add-cart.html','<div class="container">\r\n    <!-- Modal -->\r\n</div>');
$templateCache.put('app/home/home.html','<table-view dataconf="home-data" view-conf-name="home-view" update="cartDetails">\r\n</table-view>\r\n<a href="javascript:void(0)" class="btn btn-info btn-lg plus-cart" data-toggle="modal" data-target="#myModal">\r\n          <span class="glyphicon glyphicon-plus-sign"></span> Plus\r\n        </a>\r\n<div class="modal fade" id="myModal" role="dialog">\r\n    <div class="modal-dialog">\r\n        <!-- Modal content-->\r\n        <div class="modal-content">\r\n            <div class="modal-header">\r\n                <button type="button" class="close" data-dismiss="modal">&times;</button>\r\n                <h4 class="modal-title">Cart Item</h4>\r\n            </div>\r\n            <div class="modal-body cart-body">\r\n                <form>\r\n                    <div ng-repeat="field in cartView.columns">\r\n                        <div ng-if="checkFieldType(field)" class="input-group cart-form-item">\r\n                            <span class="input-group-addon">{{field.column}}</span>\r\n                            <input type="text" class="form-control" placeholder="please enter {{field.column | lowercase}} details " ng-model="cart[field.column]">\r\n                        </div>\r\n                    </div>\r\n                </form>\r\n            </div>\r\n            <div class="modal-footer">\r\n                <button type="submit" class="btn btn-info" data-dismiss="modal" ng-click="addCartDetails(cart)">ADD</button>\r\n                <button type="button" class="btn btn-info" data-dismiss="modal">Close</button>\r\n            </div>\r\n        </div>\r\n    </div>\r\n</div>');
...
$templateCache.put('app/login/login.html','<form class="loginForm">\r\n    <b>Sign in </b>\r\n    <p> to countinue your session</p>\r\n    <div class="input-group form-body">\r\n        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>\r\n        <input type="text" class="form-control" placeholder="username" ng-model="login.username">\r\n    </div>\r\n    <div class="input-group form-body">\r\n        <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>\r\n        <input type="password" class="form-control" name="password" placeholder="Password" placeholder="password" ng-model="login.password">\r\n    </div>\r\n    <button value="submit" class="form-footer btn btn-info" ng-click="submit()">Submit</button>\r\n    <button value="clear" class="form-footer btn btn-info" ng-click="reset()">Clear</button>\r\n</form>');
...
$templateCache.put('app/pendings/pendings.html','<div class="container-fluid">\r\n    <div class="col-md-3">\r\n        <p class="input-group nya-margin">\r\n            <label>Users</label>\r\n            <ol class="nya-bs-select" ng-model="selectedUser" data-live-search="true" ng-change="onChange()">\r\n                <li nya-bs-option="user in users">\r\n                    <a>{{ user.name }}  <span class="glyphicon glyphicon-ok check-mark"></span>      \r\n       \r\n                 </a>\r\n                </li>\r\n            </ol>\r\n        </p>\r\n    </div>\r\n</div>\r\n<table-view dataconf="user-data" view-conf-name="user-view">\r\n</table-view>');
